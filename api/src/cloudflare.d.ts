/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings src/cloudflare.d.ts` (hash: 614555ba374e09188af9766a6ac357b1)
// Runtime types generated with workerd@1.20250712.0 2025-06-28 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SIV3D_DOCS_VERSION: string;
		ALGOLIA_APPLICATION_ID: string;
		ALGOLIA_SEARCH_API_KEY: string;
		SIV3D_DOCS_STORAGE: R2Bucket;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SIV3D_DOCS_VERSION" | "ALGOLIA_APPLICATION_ID" | "ALGOLIA_SEARCH_API_KEY">> {}
}
